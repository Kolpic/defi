...
contract TWAPPriceProvider is Ownable {
    ...
    // Events
    event PoolRegistered(bytes32 indexed pairHash, address indexed token0, address indexed token1, address pool, uint24 fee);
    ...
    function getTWAPPrice(
        ...
        address tokenOut,
        uint256 amountIn,
        uint32 observationTime
    ) public view returns (uint256 amountOut, uint256 price) {
