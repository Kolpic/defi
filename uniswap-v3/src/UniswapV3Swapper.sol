...
contract UniswapV3Swapper {
    ...
    function swapExactInput (
        ...
        (uint256 expectedAmountOut, , , ) = quoter.quoteExactInput(encodedPath, amountIn);
    ...
    function swapExactOutput(
        ...
        // Use the quoter to get an estimate of the required input
        (uint expectedAmountIn, , ,) = quoter.quoteExactOutput(encodedPath, amountOut);
